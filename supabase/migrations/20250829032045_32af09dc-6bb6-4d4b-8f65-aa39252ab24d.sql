...
('admin@vidaleve.com', '$2b$10$K7L/Q9QIIhH0X8X8X8X8X8X8X8X8X8X8X8X8X8X8X8X8X8X8X8X8X8', 'Administrator');
...
-- Create view for admin user overview (no RLS needed for views)
