...
export const BottomNavigation: React.FC = () => {
  ...
  const navItems = [
    ...
    { icon: Heart, label: 'Flexibilidade', path: '/flexibility', requiresPremium: true, requiredTier: 'basic' as const },
    { icon: Zap, label: 'Yoga', path: '/yoga', requiresPremium: true, requiredTier: 'basic' as const },
    { icon: Star, label: 'Favoritos', path: '/favorites', requiresPremium: true, requiredTier: 'basic' as const },
