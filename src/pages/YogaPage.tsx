...
const YogaPage: React.FC = () => {
  ...
  const loadExercises = async () => {
    try {
      ...
      console.error('Error loading yoga exercises:', error);
      toast.error('Erro ao carregar exercícios de yoga');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-background pb-safe-bottom-nav">
      <div className="container mx-auto px-4 py-6">
        <BrandHeader 
          ...
          subtitle="Encontre equilíbrio e paz interior com práticas de yoga"
        />
        ...
        <Card className="p-6 mb-6 bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="text-lg font-semibold text-purple-800">Yoga & Bem-estar</h2>
          </div>
          <p className="text-purple-700 text-sm">
            O yoga combina movimento, respiração e meditação para promover o bem-estar físico e mental. 
            Pratique regularmente para reduzir o estresse, melhorar a flexibilidade e encontrar equilíbrio interior.
          </p>
        </Card>
        ...
        {exercises.length === 0 && !loading && (
          <Card className="p-8 text-center">
            ...
            <p className="text-muted-foreground">
              Os exercícios de yoga estão sendo preparados. Volte em breve!
            </p>
          </Card>
        )}
