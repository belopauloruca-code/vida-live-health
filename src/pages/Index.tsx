...
const Index = () => {
  ...
  const benefits = [
    { icon: Heart, title: 'Saúde Completa', description: 'Monitoramento abrangente da sua saúde' },
    { icon: Activity, title: 'Exercícios Personalizados', description: 'Treinos adaptados ao seu perfil' },
